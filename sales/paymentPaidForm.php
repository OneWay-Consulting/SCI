            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="input-group">
                                <button type="button" class="btn btn-danger" id="btn_cancel" style="cursor:pointer" onclick="sendAction('paymentdetailpaid.php','dispatch=listcreditpaid&id=<? echo $ticket2[0]->fnidpartner;?>');">Regresar</button>
                            </div>
                        </div>
                    </div>
                </div>
