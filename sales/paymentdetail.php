                ...
                <? for($i=0; $i<count($delivery); $i++){
                    ...
                    ?>
                        <tr>
                            ...
                            <td><img src="../images/buttons/dinero.png" width="20" height="20" alt="Pago" title="Pago" style="cursor:pointer" onclick="sendAction('paymentForm.php','dispatch=paymentdetail&id=<? echo $delivery[$i]->idov;?>');" /> </td>
                        </tr>
                        </label>
                <? }//for?>
            </table>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="input-group">
                        <button type="button" class="btn btn-danger" id="btn_cancel" style="cursor:pointer" onclick="location.href='payment.php'">Regresar</button>
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="input-group">
