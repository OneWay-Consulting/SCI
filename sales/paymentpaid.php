...
$mysql = new Mysql;
$list = Collection::getPartnerCreditPaid($mysql);

?>
<h2><span class="label label-primary">Bandeja de cobranza Realizada</span></h2>
<br />
<input class="form-control" id="myInput" type="text" placeholder="Escriba texto para filtrado de datos:..">
<br />
<button type="button" class="btn btn-success btn-sm" onclick="window.open('export/paymentgralpaid.php','Reporte Cobranza Realizada');">Rep. Cobranza Realizada Excel</button>
<center>
    ...
    <table id="c_purchase" width="70%" align="center">
        ...
        <? $facturado = 0;
            ...
            <tr id="<? echo $list[$i]->pnid;?>">
                ...
                <td><img src="../images/buttons/asignar.gif" border="0" align="Modificar Registro" title="Modificar Registro" style="cursor:pointer; height:20px; width:20px;" onclick="sendAction('paymentdetailpaid.php','dispatch=listcreditpaid&id=<? echo $list[$i]->pnid;?>');" />
                </td>
            </tr>
        <? }?>
        <tr>
